...
- **면을 채우지 말고 선화로 그린다** (MUST). 채움이 필요해 보이면 비워 둔다. 예전 아이콘들은 면을 낮은 불투명도의 무채색으로 채웠는데, 흰 배경에서 회색으로 합성되어 카테고리마다 톤이 어긋났다. 전량 정합했고 경과는 스펙 §3-3-17에 있다.
...
<svg xmlns="http://www.w3.org/2000/svg" width="70" height="70" viewBox="0 0 70 70">
  <g fill="none" stroke="<스펙 §3-2-4의 검정>" stroke-width="5" stroke-linecap="round" stroke-linejoin="round">
    <!-- 도안 -->
  </g>
