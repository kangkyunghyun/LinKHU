...
- **스토어 대시보드에 붙여넣는 것까지 대신하지 않는다.** 문서를 갱신하는 데서 끝내고, 붙여넣기는 [스펙 §7-6](../../../docs/spec/7-6-STORE.md)을 따라 사람이 한다.

## 관련 문서

- [스펙 §7-5 릴리스](../../../docs/spec/7-5-RELEASE.md) — 버전 자리와 준비 PR, 태그 push
- [스펙 §7-6 스토어 제출](../../../docs/spec/7-6-STORE.md) — 스토어별 제출 절차
