...
학사·포털, 생활·복지, 장학·진로·창업, 교육·역량, 캠퍼스·문화, 대학·행정 같은 교내 주제별 서비스부터 단과대, 학과/전공까지 총 167개 서비스를 지원하며, 설정 페이지에서 원하는 것만 골라 담을 수 있습니다.
...
릴리스와 스토어 배포 절차는 [스펙 §7-5·§7-6](docs/spec/README.md)을 따릅니다.
