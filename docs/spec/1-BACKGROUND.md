...
**제품 정체성의 경계다.** 무엇을 하는지는 요구사항이 정하지만, 무엇을 하지 않는지는 여기서 고정한다.
...
**이 표의 항목을 하려면 권한이 늘거나 서버가 생긴다.** 기능 판단이 아니라 제품 판단이므로 시작하기 전에 결정을 남긴다.
