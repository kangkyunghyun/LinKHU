...
릴리스·스토어 배포·문의·아이콘·스크린샷의 운영 절차를 기록한다.

운영 절차는 이 폴더의 각 문서가 원본이다. 배포 문구의 원본은 [문구 폴더](../copy/README.md)에 있다. 현재 구조와 동작의 계약은 [스펙](../spec/README.md)이 원본이며 여기서 반복하지 않는다.
...
1. 현재 코드와 맞지 않는 지침은 정리한다 (MUST). 작업 규칙의 원본은 [AGENTS.md](../../AGENTS.md)다.
2. 같은 내용을 두 곳에 쓰지 않는다 (MUST). 주제별 원본은 [스펙 README](../spec/README.md#주제별-원본)에서 확인한다.
