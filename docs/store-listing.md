...
[v2.7.0 업데이트]
- 설정 페이지 목록에서 서비스를 새 탭으로 열어볼 수 있습니다. 이름만 보고 고르지 않아도 어떤 사이트인지 먼저 확인할 수 있습니다.
- 팝업에서 이름이 긴 서비스가 읽기 좋게 끊어집니다. '소프트웨어융 / 합학과'처럼 글자 중간에서 잘리던 이름이 '소프트웨어 / 융합학과'로 나뉩니다.
- 학과 이름 표기를 '환경학 및 환경공학과'로 바로잡았습니다.
```
